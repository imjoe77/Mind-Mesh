...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen font-sans selection:bg-green-100">
      ...
      <div className="w-full lg:w-[480px] p-8 md:p-16 flex flex-col justify-between bg-white">
        <div className="w-full max-w-[320px] mx-auto lg:mx-0">
          ...
          <div className="mb-12 flex items-center gap-2">
            <svg className="w-8 h-8 text-[#00684a]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 22s-8-4.5-8-11.8c0-4.5 3.6-8.2 8-8.2s8 3.7 8 8.2c0 7.3-8 11.8-8 11.8z" />
            </svg>
            <span className="text-2xl font-bold text-[#2e3738] tracking-tight">Mind mesh</span>
          </div>
          ...
          <div className="space-y-5">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-300 py-2.5 rounded hover:bg-blue-50 transition duration-200"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-wider font-bold">
              <span className="bg-white px-4 text-gray-400">Or with email and password</span>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-[#00684a] p-16 flex-col justify-center relative overflow-hidden">
        ...
        <div className="absolute right-[-10%] bottom-[-10%] w-3/4 h-3/4 opacity-40 select-none">
